...
LIST_PARAMETROS: LIST_PARAMETROS coma PARAMETROS {$$ = $1; $1.push($3);}
                |PARAMETROS {$$ = [$1];}
;

PARAMETROS: TIPO identificador {$$ = INSTRUCCION.nuevaDeclaracion($1, null, this._$.first_line,this._$.first_column+1);}
;
EXEC: Rexec identificador parA parC ptcoma {$$ = INSTRUCCION.nuevoExec($2, null, this._$.first_line,this._$.first_column+1)}
        | Rexec identificador parA PARAMETROS_LLAMADA parC ptcoma {$$ = INSTRUCCION.nuevoExec($2, $4, this._$.first_line,this._$.first_column+1)}
